    ...
    <>
      {overlayState.open ? (
        <div className='fixed top-0 left-0'>
          ...
          />
          <div className='fixed rounded-xl overflow-hidden top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] z-20 flex  flex-col w-max max-w-[90vw] max-h-[92vh] bg-gray-800' style={{height: '92vh', width:'auto'}}>
            ...
            {/* --- Something like this should be implemented this (react-image-zoom) had a problem with crashing on open, react-image-magnifier-v2 had an issue with resizing
            <ImageZoom src="https://picsum.photos/seed/000/1920/1080"/>
            */}
